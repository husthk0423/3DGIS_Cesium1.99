...
import PhasedArrayRadarPrimitive from '../primitive/PhasedArrayRadarPrimitive';
/**
 * 可视域分析
...
class ViewShedAnalysis{
    ...
    add(){
        ...
        if (this.cameraPosition && this.position) {
            this.cameraPosition = this.addPositionsHeight(this.cameraPosition, this._offsetHeight); //加人的身高等因素，略微抬高一些
            this._addToScene();
        } else {
    ...
    _addToScene() {
        ...
        lightCamera.frustum = new Cesium.PerspectiveFrustum({
            fov: Cesium.Math.toRadians(179.9),
    ...
    _addRectangularSensor() {
        ...
        this._radar = new PhasedArrayRadarPrimitive({
