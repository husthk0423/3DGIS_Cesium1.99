...
let allowsIdeographicBreaking = function(chars) {
...
let allowsVerticalWritingMode = function(chars) {
    for (const char of chars) {
...
let allowsLetterSpacing = function(chars) {
    for (const char of chars) {
...
let charAllowsLetterSpacing = function(char) {
...
let charAllowsIdeographicBreaking = function(char) {
 ...
 */
let charHasUprightVerticalOrientation = function(char) {
 ...
 */
let charHasNeutralVerticalOrientation = function(char) {
 ...
 */
let charHasRotatedVerticalOrientation = function(char) {
    return !(exports.charHasUprightVerticalOrientation(char) ||
             exports.charHasNeutralVerticalOrientation(char));
};

export default {allowsIdeographicBreaking,allowsVerticalWritingMode,allowsLetterSpacing,charAllowsLetterSpacing,charAllowsIdeographicBreaking,
    charHasUprightVerticalOrientation,charHasNeutralVerticalOrientation,charHasRotatedVerticalOrientation};
