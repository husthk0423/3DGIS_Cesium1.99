...
\n\
#ifdef ENABLE_VERTEX_LIGHTING\n\
    float diffuseIntensity = clamp(czm_getLambertDiffuse(czm_lightDirectionEC, normalize(v_normalEC)) * u_lambertDiffuseMultiplier *0.9 + 0.3, 0.0, 1.0);\n\
...
\n\
        ...
        gl_FragColor = vec4(1.0);  // 2019-6-4   地形挖掘\n\
    #endif\n\
}\n\
\n\
\n\
