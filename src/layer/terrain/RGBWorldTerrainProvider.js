...
const md5 = require('md5-node');
    ...
    function RGBWorldTerrainProvider(options) {
        ...
        this._levelZeroMaximumGeometricError = TerrainProvider.getEstimatedLevelZeroGeometricErrorForAHeightmap(ellipsoid, 65, this._tilingScheme.getNumberOfXTilesAtLevel(0));
...
module.exports = RGBWorldTerrainProvider;
