class PitWallGeometry {
  ...
  createGeometry(PitWallGeometry, topHeights, bottomHeight, maxHeight = 0) {
    ...
    if (Cesium.defined(vertexFormat.position) && Cesium.defined(vertexFormat.st)) {
      ...
      min_pos = new Cesium.Cartesian3(9999999999999, 9999999999999, 9999999999999)
      max_pos = new Cesium.Cartesian3(-9999999999999, -9999999999999, -9999999999999)
      for (let i = 0; i < max.length; i++) {
        indices[i * 6 + 0] = 4 * i + 0
        indices[i * 6 + 1] = 4 * i + 1
        indices[i * 6 + 2] = 4 * i + 2
    ...
    let diff = Cesium.Cartesian3.subtract(max_pos, min_pos, new Cesium.Cartesian3())
...
module.exports = PitWallGeometry;