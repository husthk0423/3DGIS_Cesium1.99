...
import EnvelopeDataSource from './EnvelopeDataSource';
const defer =Cesium.defer;
     ...
     */
    class EnvelopeModelTileServiceImageryProvider {
        ...
        jsonPromiseResult(deferred,xyz,level,results){
            ...
            let name = x+'_'+y+'_'+z;
            let tile = new EnvelopeDataSource(name,results,level,this.viewer,this.options,this.lightMap);
...
export default EnvelopeModelTileServiceImageryProvider;
