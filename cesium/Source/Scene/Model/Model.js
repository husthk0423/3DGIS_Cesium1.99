...
function Model(options) {
  ...
  this._multiClippingPlanes= options.multiClippingPlanes;
  this._testboundingVolume=options.testboundingVolume;
  this._multiclippingPlanesMatrix = Matrix4.clone(Matrix4.IDENTITY); 
}
...
function updateReferenceMatrices(model, frameState) {
  ...
  if (model.isMultiClippingEnabled()) {
    let multiclippingPlanesMatrix = scratchClippingPlanesMatrix;
    multiclippingPlanesMatrix = Matrix4.multiply(
      context.uniformState.view3D,
      referenceMatrix,
      multiclippingPlanesMatrix
    );
    multiclippingPlanesMatrix = Matrix4.multiply(
      multiclippingPlanesMatrix,
      model._multiClippingPlanes.modelMatrix,
      multiclippingPlanesMatrix
    );
    model._multiclippingPlanesMatrix = Matrix4.inverseTranspose(
      multiclippingPlanesMatrix,
      model._multiclippingPlanesMatrix
    );
  }
}
...
/***hk����***/
Model.prototype.isMultiClippingEnabled = function () {
...
function makeModelOptions(loader, modelType, options) {
  return {
    ...
    /**hk����**/
    testboundingVolume:options.testboundingVolume,
    multiClippingPlanes: options.multiClippingPlanes,
