...
const customOutputDirectory = path.join(
  ...
  // var fileName = customOutputDirectory+'/CustomCesiumSDK.js';
  // var coustomContents = await readFile(fileName);
  // await appendFile(outputDirectory+'/Cesium.js',coustomContents);
  //
  // options.path = outputDirectory;
  // await mergeCustom(options);
...
const filesToClean = [
  ...
  "Source/custom/layer/shaders/glsl/*.js",
  "Source/**/*.d.ts",
  "Specs/SpecList.js",
  "Specs/jasmine/**",
